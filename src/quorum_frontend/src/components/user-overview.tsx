...
export function DashboardOverview() {
  ...
  const isBasePath = location.pathname === `/dashboard/user/${userid}`;
  return isBasePath ? (
              ...
              >
                ...
                <CardContent className="py-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-purple-300">Treasury</span>
                    ...
                    <div key={task.id} className="mb-4 last:mb-0">
                      <div className="flex items-center justify-between p-4 rounded-lg bg-purple-500/10 hover:bg-purple-500/20 transition-colors">
                        <div>
                          ...
                          <p className="text-sm text-purple-300">{task.org}</p>
                        </div>
                        <Badge
                          variant="outline"
